...
class FileController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        Mail::send('emails.attachment',$data, function($message){
            $message->to('linsandarmyo96@gmail.com','Linsandar')->subject('Laravel file attachment and embed');
            $message->from('overmidnight12@gmail.com','Linsandar');
        });
        return redirect('/file')->with('success','File attachment has benn sent to your email');
    }
